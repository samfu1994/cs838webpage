...
A_mat = []
B_mat = []
TABLE_A_DIR="table_A2.csv"
TABLE_B_DIR="table_B2.csv"
...
if __name__ == "__main__":
	A_mat = load_table_A(TABLE_A_DIR)
	B_mat = load_table_B(TABLE_B_DIR)
	data_merging_and_creating_file(A_mat, B_mat)
